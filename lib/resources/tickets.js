module.exports = ({ api }) => {
  api.tickets = {
    ...
    listTicketsByType: (userId, type = 'requested', queryParams) => {
      return api.request(`users/${userId}/tickets/${type}.json`, { queryParams });
    },
    create: (body) => api.request(`tickets.json`, { method: 'POST', body }),
    createMany: (body) => api.request(`tickets/create_many.json`, { method: 'POST', body }),
