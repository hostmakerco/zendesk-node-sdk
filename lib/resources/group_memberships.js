module.exports = ({ api }) => {
  api.groupMemberships = {
    ...
    listAssignablesByGroup: (groupId, queryParams) =>
      api.request(`groups/${groupId}/memberships/assignable.json`, { queryParams }),
    get: (id, queryParams) => api.request(`group_memberships/${id}.json`, { queryParams }),
    getByUser: (userId, id, queryParams) =>
      api.request(`users/${userId}/group_memberships/${id}.json`, { queryParams }),
    ...
    setAsDefault: (userId, membershipId, body) =>
      api.request(`users/${userId}/group_memberships/${membershipId}/make_default.json`, { method: 'PUT', body }),
  };
