...
function Response(response = {}, { authHeader, parseBodyManuallyAsJson = false } = {}) {
  const body = convertKeysToCamelCase(parseBodyManuallyAsJson ? JSON.parse(response.body) : response.body);
